...
const CourseCard:React.FC<CardProps> = ({course}) => {
  return (
    <Card className="w-80 md:w-72 lg:w-80 mx-auto bg-gradient-to-r from-purple-500 to-pink-500/55 text-white rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
