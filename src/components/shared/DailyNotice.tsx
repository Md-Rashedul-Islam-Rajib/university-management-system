...
const DailyNotice = () => {
  return (
    ...
    <Card className="max-w-sm mx-auto bg-gradient-to-r from-yellow-300 via-yellow-400 to-orange-400 shadow-lg rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
